      ...
      <style>{`
        ...
        @media (max-width: 680px) {
          ...
          .homeHeroCompact .clockMobileCompact {
            ...
            gap: 8px; color: var(--muted); font-size: .76rem;
          }
          ...
          .homeHeroCompact .heroBottomRow {
            margin-top: 8px !important; gap: 10px !important;
            align-items: center !important; justify-content: flex-end !important;
          }
          .homeHeroCompact .homeActions { width: auto !important; flex: 0 0 auto; }
          .homeHeroCompact .homeActions .primaryButton {
            width: auto !important; min-height: 38px; padding: 0 18px; border-radius: 11px;
          }
          .homeShell > .teamMessageBoard,
          .homeShell > .scheduleSection {
            margin-top: 12px;
          }
        ...
        <div className="heroTopRow" style={{ alignItems: 'center', gap: 18 }}>
          <div className="brandRow">
            ...
            <div>
              ...
              <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.25rem)' }}>LineFlow AI</h1>
            </div>
          </div>
          <LiveClock />
        </div>
