    ...
    <main className="shell">
      ...
      {isTammy && <>
        ...
        <section className="dashboardGrid">
          <article className="metricCard"><span>Production Schedule</span><strong>View & Modify</strong><p>Control priorities, targets, status, comments, holds, and production-plan changes.</p></article>
          <article className="metricCard"><span>Assembly Lines</span><strong>Lines 1–4</strong><p>Monitor requests, line status, urgent needs, delays, and completed deliveries.</p></article>
          <article className="metricCard"><span>Material Operations</span><strong>Live Flow</strong><p>Monitor Greg, Tristen, Jose, boom materials, hoods, delivery activity, and open issues.</p></article>
          <article className="metricCard"><span>Inventory</span><strong>Plant Visibility</strong><p>See quantities, locations, shortages, low stock, damage, overages, and material readiness.</p></article>
          <article className="metricCard"><span>Leadership Alerts</span><strong>Needs Attention</strong><p>Surface urgent requests, production risks, late deliveries, shortages, and workflow exceptions.</p></article>
          <article className="metricCard"><span>Performance</span><strong>Goals & Reports</strong><p>Review daily results, weekly/monthly goals, delivery performance, inventory accuracy, and trends.</p></article>
          <article className="metricCard"><span>Workflow Control</span><strong>Full Access</strong><p>Modify routing, priorities, assignments, plans, goals, users, and operational settings remotely.</p></article>
          <article className="metricCard"><span>Audit History</span><strong>Who Changed What</strong><p>Review schedule, inventory, routing, and workflow changes with user, time, and reason.</p></article>
        </section>
      </>}
      ...
      {isJose && <section className="dashboardGrid">
        ...
        <article className="metricCard"><span>Production Schedule</span><strong>View & Update</strong><p>Update boom-line schedule, completion targets, status, and comments.</p></article>
